...
public class HibernateMeetupDAOTest {
	...
	public void testSelectById() {
		// Select after insert
		Meetup insertMeetup = new Meetup(1, "Admin", "Administrator role", new Date(1992, 04, 19),
				new Date(1992, 04, 12), 1, 19.015f, 20.013f, new User());
	...
	/**
	 * Test method for
	 * {@link io.wzw.backend.data.dao.impl.HibernateRoleDAO#selectAll()}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link io.wzw.backend.data.dao.impl.HibernateRoleDAO#insert(io.wzw.backend.data.model.Role)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link io.wzw.backend.data.dao.impl.HibernateRoleDAO#update(io.wzw.backend.data.model.Role)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link io.wzw.backend.data.dao.impl.HibernateRoleDAO#delete(io.wzw.backend.data.model.Role)}.
	 */
	@Test
